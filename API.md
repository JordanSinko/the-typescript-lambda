...
Name|Description
----|-----------
[EsbuildFunction](#the-typescript-lambda-esbuildfunction)|*No description*
...
Name|Description
----|-----------
[EsbuildFunctionProps](#the-typescript-lambda-esbuildfunctionprops)|*No description*



## class EsbuildFunction  <a id="the-typescript-lambda-esbuildfunction"></a>
...
* **props** (<code>[EsbuildFunctionProps](#the-typescript-lambda-esbuildfunctionprops)</code>)  *No description*
  ...
  * **entryPoints** (<code>Array<string></code>)  *No description* 
  * **projectRoot** (<code>string</code>)  *No description* 
  * **awsSdkConnectionReuse** (<code>boolean</code>)  *No description* __*Optional*__
  * **bundle** (<code>boolean</code>)  *No description* __*Optional*__
  * **handler** (<code>string</code>)  *No description* __*Optional*__
  * **minify** (<code>boolean</code>)  *No description* __*Optional*__
  * **outdir** (<code>string</code>)  *No description* __*Optional*__
  * **runtime** (<code>[Runtime](#aws-cdk-aws-lambda-runtime)</code>)  *No description* __*Optional*__
  * **sourcemap** (<code>boolean</code>)  *No description* __*Optional*__
  * **target** (<code>string</code>)  *No description* __*Optional*__




## struct EsbuildFunctionProps  <a id="the-typescript-lambda-esbuildfunctionprops"></a>
...
**awsSdkConnectionReuse**? | <code>boolean</code> | __*Optional*__
**bundle**? | <code>boolean</code> | __*Optional*__
...
**handler**? | <code>string</code> | __*Optional*__
...
**minify**? | <code>boolean</code> | __*Optional*__
...
**runtime**? | <code>[Runtime](#aws-cdk-aws-lambda-runtime)</code> | __*Optional*__
...
**sourcemap**? | <code>boolean</code> | __*Optional*__
